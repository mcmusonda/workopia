<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data" >
            ...
            <x-inputs.text-area id="description" name="description" lable="Description" placeholder="We are seeking a skilled and motivated software developer ..." :value="old('description', $job->description)" />

            <x-inputs.text id="salary" name="salary" label="Salary" type="number" placeholder="$70,000 - $90,000" :value="old('salary', $job->salary)" />

            <x-inputs.text-area id="requirements" name="requirements" label="Requirements" placeholder="Bacher's degree in Computer Science" :value="old('requirements', $job->requirements)" />
