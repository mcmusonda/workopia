        ...
        <div class="rounded-lg shadow-md bg-white p-3">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-3 ml-4">
                    <a
                        href="{{ route('jobs.edit', $job->id) }}" class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded">Edit</a>
                    <!-- Delete Form -->
            ...
            @auth 
                ...
                <div x-data="{ open: false}">
                    ...
                    <div x-show="open" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                        <div @click.away="open = false"   class="bg-white p-6 rounded shadow-md w-full max-w-md">
                            <h3 class="text-lg font-semibold mb-4">
                                Apply for {{ $job->title }}
                            </h3>
                            <form  method="post" enctype="multipart/form-data" action="{{ route('applicant.store', $job) }}">
                                @csrf
                                ...
                                <x-inputs.text-area id="message" name="message" label="Message" :cols="37" />
                                ...
                                <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Submit Application</button>
